...
public class LosControllerIntegrationTest {
    ...
    public void test_if_get_los_nodes_by_uris_returns_valid_response() {
        LosNodes losNodes =
                this.restTemplate.getForObject("http://localhost:" + port + "/los/themes-and-words?uris=https%3A%2F%2Fpsi.norge.no%2Flos%2Ford%2Fabort,https%3A%2F%2Fpsi.norge.no%2Flos%2Ford%2Fadopsjon", LosNodes.class);
    ...
    public void test_if_get_los_nodes_by_uris_with_unknown_uri_returns_valid_response() {
        LosNodes losNodes =
                this.restTemplate.getForObject("http://localhost:" + port + "/los/themes-and-words?uris=https%3A%2F%2Fpsi.norge.no%2Flos%2Ford%2Fabort,https%3A%2F%2Fpsi.norge.no%2Flos%2Ford%2Fukjent", LosNodes.class);
