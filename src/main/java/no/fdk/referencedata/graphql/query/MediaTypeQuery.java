...
public class MediaTypeQuery {
    ...
    @QueryMapping
    public List<MediaType> getMediaTypesByType(@Argument String type) {
    ...
    @QueryMapping
    public MediaType getMediaTypeByTypeAndSubType(@Argument String type, @Argument String subType) {
